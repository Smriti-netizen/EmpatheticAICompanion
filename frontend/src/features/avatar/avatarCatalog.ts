...
/** Face landmarks as % of the square portrait PNG (object-contain, no crop). */
...
export const AVATAR_PRESETS: AvatarPreset[] = [
  {
    ...
    face: {
      // Measured on 1024² PNG — lids sit on the glossy black pupils.
  ...
  },
  {
    ...
    face: {
      ...
      // Soft dark fringe above Coco's eyes (not flat black).
      lidColor: "#3a3332",
